...
export const aboutMeData: AboutMeData = {
  ...
  paragraphs: [
    ...
    "When I'm not studying, I enjoy playing video games, Warhammer with myth society, debates at Star Wars society, and am currently creating smaller personal projects to continue learning and improving my skills."
  ],
  education: {
